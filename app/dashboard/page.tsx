...
function DashboardContent() {
    ...
    const navItems = [
        ...
        { id: 'import', label: 'Lead Warmer', icon: svgIcon('M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M8.5 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8z M20 8v6 M23 11h-6'), section: 'comments' },
        // Other
